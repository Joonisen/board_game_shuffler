/* Written and used in MySQL workbench.
...
CREATE TABLE board_game (
	boardgameid		INTEGER		NOT NULL	PRIMARY KEY,
    	title			VARCHAR(64)	NOT NULL, /* Can sadly not be unique, since there might exist another edition of the same title */
	...
	/* playtime_in_min is based on boardgamegeek's MAX amount of playtime in minutes for a certain game,
	   since this is usually the case when playing casually or playing an unfamiliar game */
